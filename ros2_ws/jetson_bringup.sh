...
FUSION_DEPTH_FRONT_CORRIDOR_HALF_WIDTH_M="${FUSION_DEPTH_FRONT_CORRIDOR_HALF_WIDTH_M:-0.50}"
...
NAV_ACTIVE_SCAN_CONFIRM_STEPS="${NAV_ACTIVE_SCAN_CONFIRM_STEPS:-4}"
NAV_ACTIVE_SCAN_STEPS="${NAV_ACTIVE_SCAN_STEPS:-5}"
NAV_ACTIVE_SCAN_FRONT_CLEAR_M="${NAV_ACTIVE_SCAN_FRONT_CLEAR_M:-1.35}"
...
NAV_CONTINUOUS_HORIZON_S="${NAV_CONTINUOUS_HORIZON_S:-1.10}"
...
NAV_CONTINUOUS_SLOWDOWN_CLEARANCE_M="${NAV_CONTINUOUS_SLOWDOWN_CLEARANCE_M:-1.35}"
NAV_CONTINUOUS_STOP_CLEARANCE_M="${NAV_CONTINUOUS_STOP_CLEARANCE_M:-0.58}"
