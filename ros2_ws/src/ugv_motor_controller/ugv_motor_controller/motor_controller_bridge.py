...
class MotorControllerBridge(Node):
    def __init__(self) -> None:
        ...
        self.declare_parameter("pwm_min_us", 1000)
        ...
        self.declare_parameter("teensy_pid_kp", 0.04)
        self.declare_parameter("teensy_pid_ki", 0.0)
        self.declare_parameter("teensy_pid_kd", 0.0)
        self.declare_parameter("teensy_pid_feedforward_us_per_tps", 0.08)
        ...
        self.declare_parameter("teensy_pid_static_ff_us", 410.0)
        ...
        self.declare_parameter("teensy_right_reverse_pwm_floor_us", 0.0)
        ...
        self.declare_parameter("allow_teensy_param_sync_best_effort", True)
        self.declare_parameter("teensy_param_best_effort_status_count", 3)
        ...
        self.teensy_right_reverse_pid_feedforward_us_per_tps = _side_param_or_global(
            self.get_parameter("teensy_right_reverse_pid_feedforward_us_per_tps").value,
            self.teensy_right_pid_feedforward_us_per_tps,
            name="teensy_right_reverse_pid_feedforward_us_per_tps",
        )
        ...
        self.teensy_right_reverse_pid_static_ff_us = _side_param_or_global(
            self.get_parameter("teensy_right_reverse_pid_static_ff_us").value,
            self.teensy_right_pid_static_ff_us,
            name="teensy_right_reverse_pid_static_ff_us",
        )
        self.teensy_right_reverse_pwm_floor_us = max(
            0.0,
            finite_float(
                self.get_parameter("teensy_right_reverse_pwm_floor_us").value,
                name="teensy_right_reverse_pwm_floor_us",
            ),
        )
        ...
        self.allow_teensy_param_sync_best_effort = bool(
            self.get_parameter("allow_teensy_param_sync_best_effort").value
        )
        self.teensy_param_best_effort_status_count = max(
            1,
            int(self.get_parameter("teensy_param_best_effort_status_count").value),
        )
        ...
        self.teensy_status_count = 0
        self.teensy_param_sync_best_effort_active = False
    ...
    def _handle_status(self, line: str) -> None:
        ...
        self.teensy_status_count += 1
        self._maybe_accept_param_sync_best_effort()
    ...
    def _maybe_accept_param_sync_best_effort(self) -> None:
        if self.teensy_pid_params_synced or self.teensy_param_sync_best_effort_active:
            return
        if not self.allow_teensy_param_sync_best_effort:
            return
        if self.teensy_status_count < self.teensy_param_best_effort_status_count:
            return
        self.teensy_param_sync_best_effort_active = True
        self.teensy_pid_params_synced = True
        self.teensy_pid_param_sync_pending = []
        self.teensy_pid_param_sync_failed = False
        self.teensy_pid_param_sync_reason = "best_effort_status_stream"
        self.get_logger().warn(
            "Teensy parameter sync accepted in best-effort mode after valid status stream; "
            "continuing with firmware/default parameters"
        )
        self._publish_status(event="teensy param sync best effort")
            ...
            params.update(
                OrderedDict(
                    [
                        ...
                        (
                            "right_reverse_ff_us_per_tps",
                            self.teensy_right_reverse_pid_feedforward_us_per_tps,
                        ),
                        ("left_static_ff_us", self.teensy_left_pid_static_ff_us),
                        ("right_static_ff_us", self.teensy_right_pid_static_ff_us),
                        ("right_reverse_static_ff_us", self.teensy_right_reverse_pid_static_ff_us),
                        ("right_reverse_pwm_floor_us", self.teensy_right_reverse_pwm_floor_us),
    ...
    def _copy_param_sync_state(self) -> None:
        if self.teensy_param_sync_best_effort_active:
            self.teensy_pid_params_synced = True
            self.teensy_pid_param_sync_pending = []
            self.teensy_pid_param_sync_failed = False
            self.teensy_pid_param_sync_reason = "best_effort_status_stream"
    ...
    def _publish_status(self, **extra: Any) -> None:
        ...
        status: Dict[str, Any] = {
            ...
            "teensy_param_sync_best_effort_active": bool(self.teensy_param_sync_best_effort_active),
            "allow_teensy_param_sync_best_effort": bool(self.allow_teensy_param_sync_best_effort),
            ...
            "teensy_right_reverse_pid_feedforward_us_per_tps": round(
                self.teensy_right_reverse_pid_feedforward_us_per_tps,
                6,
            ),
            ...
            "teensy_right_reverse_pwm_floor_us": round(self.teensy_right_reverse_pwm_floor_us, 3),
