...
def test_round2_row_transition_test_profile_resolves_row_length():
    ...
    for token in [
        ...
        'profile_default SWEEP_TURN_STYLE "segmented_pivot_90"',
        ...
        'profile_default SWEEP_PIVOT_MIN_EMITTED_OMEGA_RPS "0.25"',
        'profile_default SWEEP_PIVOT_MAX_EMITTED_OMEGA_RPS "0.45"',
        'profile_default SWEEP_PIVOT_WHEEL_MIN_MPS "0.08"',
        'profile_default SWEEP_PIVOT_SETTLE_FRAMES "3"',
        'profile_default SWEEP_CROSS_LANE_V_MPS "0.12"',
        'profile_default SWEEP_CROSS_LANE_HEADING_KP "1.10"',
