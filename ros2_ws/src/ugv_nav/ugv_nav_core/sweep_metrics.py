...
class SweepMetricsLogger:
    FIELDNAMES = [
        ...
        "turn_command_phase",
        "pivot_turn_active",
        "pivot_target_yaw_deg",
        "pivot_yaw_error_deg",
        "pivot_emitted_omega_radps",
        "pivot_left_target_mps",
        "pivot_right_target_mps",
        "pivot_settle_count",
        "pivot_command_phase",
        "cross_lane_active",
        "cross_lane_target_y_m",
        "cross_lane_error_m",
        "target_side_yaw_deg",
    ...
    def record(self, status: dict, motor_status: Optional[dict] = None) -> None:
        ...
        row = {
            ...
            "pivot_turn_active": bool(v2.get("pivot_turn_active", False)),
            "pivot_target_yaw_deg": v2.get("pivot_target_yaw_deg"),
            "pivot_yaw_error_deg": v2.get("pivot_yaw_error_deg"),
            "pivot_emitted_omega_radps": v2.get("pivot_emitted_omega_radps"),
            "pivot_left_target_mps": v2.get("pivot_left_target_mps"),
            "pivot_right_target_mps": v2.get("pivot_right_target_mps"),
            "pivot_settle_count": v2.get("pivot_settle_count"),
            "pivot_command_phase": v2.get("pivot_command_phase", ""),
            "cross_lane_active": bool(v2.get("cross_lane_active", False)),
            "cross_lane_target_y_m": v2.get("cross_lane_target_y_m"),
            "cross_lane_error_m": v2.get("cross_lane_error_m"),
