...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("nav_challenge2_align_arc_speed_mps", default_value="0.18"),
            DeclareLaunchArgument("nav_challenge2_align_max_omega_radps", default_value="0.85"),
            DeclareLaunchArgument("nav_challenge2_align_min_turn_radius_m", default_value="0.50"),
