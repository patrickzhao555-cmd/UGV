...
#include "ugv_sensor_sync/msg/detail/uwb_range__rosidl_typesupport_fastrtps_c.h"
...
#include "ugv_sensor_sync/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_ugv_sensor_sync
...
using _UwbRange__ros_msg_type = ugv_sensor_sync__msg__UwbRange;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ugv_sensor_sync
size_t get_serialized_size_ugv_sensor_sync__msg__UwbRange(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _UwbRange__ros_msg_type * ros_message = static_cast<const _UwbRange__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _UwbRange__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ugv_sensor_sync__msg__UwbRange(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ugv_sensor_sync
size_t max_serialized_size_ugv_sensor_sync__msg__UwbRange(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ugv_sensor_sync__msg__UwbRange;
    is_plain =
      (
...
static size_t _UwbRange__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ugv_sensor_sync__msg__UwbRange(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ugv_sensor_sync, msg, UwbRange)() {
