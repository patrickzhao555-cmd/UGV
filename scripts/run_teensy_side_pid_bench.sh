...
export MOTOR_TRACK_WIDTH_M="${MOTOR_TRACK_WIDTH_M:-0.416}"
export MOTOR_TEENSY_PID_KP="${MOTOR_TEENSY_PID_KP:-0.05}"
...
export MOTOR_TEENSY_PID_STATIC_FF_US="${MOTOR_TEENSY_PID_STATIC_FF_US:-170.0}"
export MOTOR_TEENSY_CONTROL_HZ="${MOTOR_TEENSY_CONTROL_HZ:-50.0}"
