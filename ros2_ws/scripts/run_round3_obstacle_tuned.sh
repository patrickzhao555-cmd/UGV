...
export UGV_PROFILE="${UGV_PROFILE:-round3_obstacle_tuned}"
export MOTOR_PORT="${MOTOR_PORT:-$(first_existing_port /dev/ttyACM0 /dev/ttyACM1 /dev/ttyUSB1 /dev/ttyUSB0 || true)}"
export LIDAR_PORT="${LIDAR_PORT:-$(first_existing_port /dev/ttyUSB0 /dev/ttyUSB1 /dev/ttyACM0 /dev/ttyACM1 || true)}"
